...
public final class TreeFormatter {
    ...
    private TreeFormatter() {
        ...
        logger = Logger.getLogger("TreeFormatter");
    ...
    private JsonGenerator generate() {
        ...
        try {
            ...
            logger.severe("The generator failed " + ex.getMessage());
            return null;
        }
    }
    //__________________________________________________________________________
    ...
    public Station jsonRead(String data) {
        ...
        try {
            ...
            logger.severe("Json read failed " + ex.getMessage());
    ...
    public String writeStationContent(Station station, String path) {
        ...
        try {
            ...
            logger.severe("Write station failed " + ex.getMessage());
            return null;
        }
    }
    //__________________________________________________________________________
    ...
    public String writeStationListFields(List<Station> stationList,
        ...
        try {
            ...
            logger.severe("Write fields failed " + ex.getMessage());
            return null;
        }
    }
    //__________________________________________________________________________
    ...
    public String writeStationListNames(List<Station> stationList) {
        ...
        try {
            ...
            logger.severe("Write names failed " + ex.getMessage());
            return null;
        }
    }
    //__________________________________________________________________________
